...
[Pivoting and Tunnelling](https://medium.com/@kuwaitison/pivoting-and-tunneling-for-oscp-and-beyond-cheat-sheet-3435d1d6022)
...
[AD Cheetsheet](https://medium.com/@dw3113r/active-directory-attack-cheat-sheet-ea9e9744028d)
...
[Enumerating AD via RPC rpcclient commands](https://www.hackingarticles.in/active-directory-enumeration-rpcclient/)
​
[Attacking Kerberos](https://m0chan.github.io/2019/07/31/How-To-Attack-Kerberos-101.html#from-linux)
...
[AD Deep Dive](https://zer1t0.gitlab.io/posts/attacking_ad/)

[Reverse Shell One Liners](https://www.hackingarticles.in/get-reverse-shell-via-windows-one-liner/)

[Wadcoms Windows cheatsheet](https://wadcoms.github.io/)

[PentestMonkey](pentestmonkey.net/cheat-sheet/)
   
[Explain Shell](https://www.explainshell.com/)

[Command cheat sheet by port](https://liodeus.github.io/2020/09/18/OSCP-personal-cheatsheet.html)

[AD Mind Map ](https://www.xmind.net/m/5dypm8/)

[CertUtil abuse](https://www.hackingarticles.in/windows-for-pentester-certutil/)

[Living off the Land Binaries](https://lolbas-project.github.io/)

[Active Directory and Windows Help](https://wadcoms.github.io/)
...
[mssql pentesting](https://book.hacktricks.xyz/pentesting/pentesting-mssql-microsoft-sql-server)
...
[SMB Enum](https://sensepost.com/blog/2018/a-new-look-at-null-sessions-and-user-enumeration/)

[Python virtual envs](https://packaging.python.org/en/latest/guides/installing-using-pip-and-virtual-environments/)

[Run Burp from command line](https://portswigger.net/burp/documentation/desktop/getting-started/launch-from-command-line)

[Crackmapexec](https://ptestmethod.readthedocs.io/en/latest/cme.html)

[Crackmapexec 2](https://www.ivoidwarranties.tech/posts/pentesting-tuts/cme/crackmapexec/)

[Manual Windows Privilege Escalation Steps](https://book.hacktricks.xyz/windows/windows-local-privilege-escalation#modify-service-binary-path)

[Helpful IEX payloads](https://gist.github.com/jivoi/c354eaaf3019352ce32522f916c03d70)
